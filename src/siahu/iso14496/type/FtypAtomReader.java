 ...
 * may be conformant to this specification and not contain a file-type box.
 * Files with no file-type box should be read as if they contained an FTYP box
 * with <code>Major_brand='mp41',
 ...
 * possible to speak of a single ‘type’ or ‘brand’ for the file. This
 * means that the utility of the file name extension and Multipurpose Internet
 * Mail Extension (MIME) type are somewhat reduced.
 * 
 * <p>
 ...
 * <p>
 * <code>major_brand</code> – is a brand identifier
 * <p>
 * <code>minor_version</code> – is an informative integer for the minor
 * version of the major brand
 * <p>
 * <code>compatible_brands</code> – is a list, to the end of the box, of
 * brands
 * 
 * @author psiahu
 * 
