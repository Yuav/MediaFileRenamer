...
/**
 * <p>Boxes start with a header which gives both size and type. The header permits compact or extended size (32
 ...
 * 
 * <p>The size is the entire size of the box, including the size and type header, fields, and all contained boxes. This
 * facilitates general parsing of the file.
 * 
 * <p>The definitions of boxes are given in the syntax description language (SDL) defined in MPEG-4 (see reference
 * in clause 2). Comments in the code fragments in this specification indicate informative material.
 * 
 * <p>The fields in the objects are stored with the most significant byte first, commonly known as network byte order
