...
public class MOVExtractor {
	...
	private static Entry[] find(RandomAccessFile file, String boxtype, Entry boundary) throws IOException {
	...
	private static Entry findPath(RandomAccessFile file, String path, Entry boundary) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		RandomAccessFile file = new RandomAccessFile(new File("/home/psiahu/test2.mov"), "r");
		RandomAccessFile outfile = new RandomAccessFile(new File("/home/psiahu/video.raw"), "rw");
...
//						outfile.write(buf);
						int offset = 0;
						for (int j = 0; j < spc; j++) {
							outfile.writeBytes(new BigInteger(Arrays.copyOfRange(buf, offset, offset+=4)).toString() + "\n");
						}
					}
					break;
				}
